function [Y,W] = ICA_threshold_infomax(Sica,WC,Wica,P_ica,acthreshold1,acthreshold2,enthreshold1,enthreshold2,kuthreshold1,kuthreshold2,vathreshold1,vathreshold2)
% This is the threshold selection program by Wei Tao and Luchang Li.
%  [Y,W]=ICA_threshold_sobi(Sica,WC,Wica,P_ica,acthreshold1,acthreshold2,enthreshold1,enthreshold2,kuthreshold1,kuthreshold2)
%  produces a matrix Y of dimension [m by T].
%  which is an estimate of clean signals processed by the infomax algorithm.
